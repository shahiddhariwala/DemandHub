...
$sql ="Select * FROM atm where counter > 5 and lookingflag = 0";
$atm=mysqli_query($conn,$sql);

$sql ="Select * FROM restaurant where counter > 5 and lookingflag = 0";
$restaurant=mysqli_query($conn,$sql);

$sql ="Select * FROM hospital where counter > 5 and lookingflag = 0";
$hospital=mysqli_query($conn,$sql);

$sql ="Select * FROM pharmacy where counter > 5 and lookingflag = 0";
$pharmacy=mysqli_query($conn,$sql);

$sql ="Select * FROM supermarket where counter > 5 and lookingflag = 0";
$supermarket=mysqli_query($conn,$sql);

$sql ="Select * FROM petrolpump where counter > 5 and lookingflag = 0";
...
<div id="wrapper">
	...
	<div class="container">
		<div class="row">
			<div class="col-lg-12">
				<h2 class="pageTitle">Business Opportunity Feed &#x1F4B8;</h2>
			</div>
		</div>
	</div>
	<section id="content">
	<div class="container">
		<!-- end divider -->
		<h3>Following are the business opportunity in chembur region &#127776; </h3>
		...
		<div class="panel">
			...
			<table align="center" border="1px" style="color:black;">
				<tr>
					...
					<!-- <th>Is Someone Already Planning for Business Here</th> -->
				</tr>
				<?php
			...
			<span style="color:black">Intrested in any of above opportunity? <a href=" bookOpportunity.html"><h5>GRAB IT</h5></a></span>
		</div>
		...
		<div class="panel">
			...
			<span style="color:black">Intrested in any of above opportunity? <a href=" bookOpportunity.html"><h5>GRAB IT</h5></a></span>		</div>
